<template>
    <div>
        ...
        <div class="container" style="min-height: 500px;">
           ...
           <div style="float: left;border: 2px solid green; border-radius: 5px;padding: 2px 45px;margin:20px;" v-for='(item,index) in temperature' :key="index"  @click="TemperatureDetails(item)">
